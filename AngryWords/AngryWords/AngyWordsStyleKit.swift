...
public class AngyWordsStyleKit : NSObject {
    ...
    public class func drawCanvasWoodBlockHorizontal() {
        ...
        let rectangle22Path = UIBezierPath(rect: CGRectMake(79, 1, 1, 15))
        CGContextSaveGState(context)
        rectangle22Path.addClip()
        CGContextDrawLinearGradient(context, gradient4, CGPointMake(79, 8.5), CGPointMake(80, 8.5), 0)
        CGContextRestoreGState(context)
    }
    ...
    public class func drawCanvasWoodBlockVertical() {
        ...
        let rectangle23Path = UIBezierPath(rect: CGRectMake(-40, -7.5, 80, 16))
        AngyWordsStyleKit.babbelLightOrange75.setFill()
        ...
        rectangle24Path.moveToPoint(CGPointMake(39.66, -1.07))
        rectangle24Path.addCurveToPoint(CGPointMake(27.96, -1.23), controlPoint1: CGPointMake(39.66, -1.07), controlPoint2: CGPointMake(34.39, -1.2))
        rectangle24Path.addCurveToPoint(CGPointMake(9.03, -1.23), controlPoint1: CGPointMake(22.53, -1.24), controlPoint2: CGPointMake(15.22, -0.76))
        rectangle24Path.addCurveToPoint(CGPointMake(-18.52, -1.21), controlPoint1: CGPointMake(2.83, -1.69), controlPoint2: CGPointMake(-16.36, -0.71))
        rectangle24Path.addCurveToPoint(CGPointMake(-38.47, -1.07), controlPoint1: CGPointMake(-21.26, -1.84), controlPoint2: CGPointMake(-37.38, -1.17))
        rectangle24Path.addCurveToPoint(CGPointMake(-38.47, -7.09), controlPoint1: CGPointMake(-41.91, -0.76), controlPoint2: CGPointMake(-38.47, -7.09))
        rectangle24Path.addCurveToPoint(CGPointMake(-29.87, -7.09), controlPoint1: CGPointMake(-38.47, -7.09), controlPoint2: CGPointMake(-33.31, -6.63))
        rectangle24Path.addCurveToPoint(CGPointMake(-16.79, -7.09), controlPoint1: CGPointMake(-26.42, -7.56), controlPoint2: CGPointMake(-14.72, -7.71))
        rectangle24Path.addCurveToPoint(CGPointMake(2.83, -6.32), controlPoint1: CGPointMake(-18.85, -6.48), controlPoint2: CGPointMake(-5.08, -6.78))
        rectangle24Path.addCurveToPoint(CGPointMake(15.91, -7.09), controlPoint1: CGPointMake(10.75, -5.86), controlPoint2: CGPointMake(15.91, -7.09))
        rectangle24Path.addCurveToPoint(CGPointMake(27.96, -7.09), controlPoint1: CGPointMake(15.91, -7.09), controlPoint2: CGPointMake(25.2, -7.71))
        rectangle24Path.addCurveToPoint(CGPointMake(39.66, -7.09), controlPoint1: CGPointMake(30.71, -6.48), controlPoint2: CGPointMake(40.76, -8.02))
        rectangle24Path.addCurveToPoint(CGPointMake(39.66, -1.07), controlPoint1: CGPointMake(38.56, -6.17), controlPoint2: CGPointMake(39.66, -1.07))
        rectangle24Path.closePath()
        CGContextSaveGState(context)
        rectangle24Path.addClip()
        CGContextDrawLinearGradient(context, gradient3, CGPointMake(-0.13, -1.02), CGPointMake(-0.13, -7.5), 0)
        CGContextRestoreGState(context)


        //// Rectangle 25 Drawing
        var rectangle25Path = UIBezierPath()
        rectangle25Path.moveToPoint(CGPointMake(39.66, 7.67))
        rectangle25Path.addCurveToPoint(CGPointMake(28.15, 7.45), controlPoint1: CGPointMake(39.66, 7.67), controlPoint2: CGPointMake(34.48, 7.48))
        rectangle25Path.addCurveToPoint(CGPointMake(9.52, 7.45), controlPoint1: CGPointMake(22.8, 7.43), controlPoint2: CGPointMake(15.62, 8.11))
        rectangle25Path.addCurveToPoint(CGPointMake(-17.58, 7.48), controlPoint1: CGPointMake(3.43, 6.8), controlPoint2: CGPointMake(-15.46, 8.18))
        rectangle25Path.addCurveToPoint(CGPointMake(-37.21, 7.67), controlPoint1: CGPointMake(-20.28, 6.58), controlPoint2: CGPointMake(-36.14, 7.53))
        rectangle25Path.addCurveToPoint(CGPointMake(-37.21, -0.83), controlPoint1: CGPointMake(-40.6, 8.11), controlPoint2: CGPointMake(-37.21, -0.83))
        rectangle25Path.addCurveToPoint(CGPointMake(-28.75, -0.83), controlPoint1: CGPointMake(-37.21, -0.83), controlPoint2: CGPointMake(-32.13, -0.18))
        rectangle25Path.addCurveToPoint(CGPointMake(-15.88, -0.83), controlPoint1: CGPointMake(-25.36, -1.48), controlPoint2: CGPointMake(-13.85, -1.7))
        rectangle25Path.addCurveToPoint(CGPointMake(3.43, 0.26), controlPoint1: CGPointMake(-17.91, 0.04), controlPoint2: CGPointMake(-4.36, -0.39))
        rectangle25Path.addCurveToPoint(CGPointMake(16.29, -0.83), controlPoint1: CGPointMake(11.21, 0.91), controlPoint2: CGPointMake(16.29, -0.83))
        rectangle25Path.addCurveToPoint(CGPointMake(28.15, -0.83), controlPoint1: CGPointMake(16.29, -0.83), controlPoint2: CGPointMake(25.44, -1.7))
        rectangle25Path.addCurveToPoint(CGPointMake(39.66, -0.83), controlPoint1: CGPointMake(30.86, 0.04), controlPoint2: CGPointMake(40.74, -2.14))
        rectangle25Path.addCurveToPoint(CGPointMake(39.66, 7.67), controlPoint1: CGPointMake(38.58, 0.48), controlPoint2: CGPointMake(39.66, 7.67))
        rectangle25Path.closePath()
        CGContextSaveGState(context)
        rectangle25Path.addClip()
        CGContextDrawLinearGradient(context, gradient3, CGPointMake(0.51, -1.4), CGPointMake(0.51, 7.74), 0)
        CGContextRestoreGState(context)


        //// Rectangle 26 Drawing
        var rectangle26Path = UIBezierPath()
        rectangle26Path.moveToPoint(CGPointMake(38.02, -2.57))
        rectangle26Path.addCurveToPoint(CGPointMake(36.69, -2.64), controlPoint1: CGPointMake(38.02, -2.57), controlPoint2: CGPointMake(37.42, -2.63))
        rectangle26Path.addCurveToPoint(CGPointMake(34.54, -2.64), controlPoint1: CGPointMake(36.07, -2.65), controlPoint2: CGPointMake(35.24, -2.43))
        rectangle26Path.addCurveToPoint(CGPointMake(31.41, -2.63), controlPoint1: CGPointMake(33.84, -2.85), controlPoint2: CGPointMake(31.66, -2.41))
        rectangle26Path.addCurveToPoint(CGPointMake(19.74, -2.55), controlPoint1: CGPointMake(31.1, -2.92), controlPoint2: CGPointMake(21.19, -1.9))
        rectangle26Path.addCurveToPoint(CGPointMake(25.64, -5.21), controlPoint1: CGPointMake(18.3, -3.19), controlPoint2: CGPointMake(25.64, -5.21))
        rectangle26Path.addCurveToPoint(CGPointMake(28.46, -5.21), controlPoint1: CGPointMake(25.64, -5.21), controlPoint2: CGPointMake(28.07, -5.01))
        rectangle26Path.addCurveToPoint(CGPointMake(31.61, -5.27), controlPoint1: CGPointMake(28.85, -5.42), controlPoint2: CGPointMake(31.84, -5.55))
        rectangle26Path.addCurveToPoint(CGPointMake(33.84, -4.93), controlPoint1: CGPointMake(31.38, -5), controlPoint2: CGPointMake(32.94, -5.14))
        rectangle26Path.addCurveToPoint(CGPointMake(35.32, -5.27), controlPoint1: CGPointMake(34.74, -4.72), controlPoint2: CGPointMake(35.32, -5.27))
        rectangle26Path.addCurveToPoint(CGPointMake(36.69, -5.27), controlPoint1: CGPointMake(35.32, -5.27), controlPoint2: CGPointMake(36.38, -5.55))
        rectangle26Path.addCurveToPoint(CGPointMake(38.02, -5.27), controlPoint1: CGPointMake(37, -5), controlPoint2: CGPointMake(38.14, -5.69))
        rectangle26Path.addCurveToPoint(CGPointMake(38.02, -2.57), controlPoint1: CGPointMake(37.89, -4.86), controlPoint2: CGPointMake(38.02, -2.57))
        ...
        rectangle27Path.moveToPoint(CGPointMake(6.86, 1.62))
        rectangle27Path.addCurveToPoint(CGPointMake(9.51, 1.56), controlPoint1: CGPointMake(6.86, 1.62), controlPoint2: CGPointMake(8.06, 1.57))
        rectangle27Path.addCurveToPoint(CGPointMake(12.31, 3.55), controlPoint1: CGPointMake(10.74, 1.56), controlPoint2: CGPointMake(10.91, 3.73))
        rectangle27Path.addCurveToPoint(CGPointMake(20.02, 1.57), controlPoint1: CGPointMake(13.71, 3.37), controlPoint2: CGPointMake(19.53, 1.77))
        rectangle27Path.addCurveToPoint(CGPointMake(24.53, 1.62), controlPoint1: CGPointMake(20.64, 1.32), controlPoint2: CGPointMake(24.28, 1.59))
        rectangle27Path.addCurveToPoint(CGPointMake(24.53, -0.73), controlPoint1: CGPointMake(25.3, 1.74), controlPoint2: CGPointMake(24.53, -0.73))
        rectangle27Path.addCurveToPoint(CGPointMake(29.49, -1.4), controlPoint1: CGPointMake(24.53, -0.73), controlPoint2: CGPointMake(30.27, -1.22))
        rectangle27Path.addCurveToPoint(CGPointMake(19.62, -0.73), controlPoint1: CGPointMake(28.71, -1.59), controlPoint2: CGPointMake(19.16, -0.97))
        rectangle27Path.addCurveToPoint(CGPointMake(15.19, -0.43), controlPoint1: CGPointMake(20.09, -0.49), controlPoint2: CGPointMake(16.98, -0.61))
        rectangle27Path.addCurveToPoint(CGPointMake(12.23, -0.73), controlPoint1: CGPointMake(13.4, -0.24), controlPoint2: CGPointMake(12.23, -0.73))
        rectangle27Path.addCurveToPoint(CGPointMake(9.51, -0.73), controlPoint1: CGPointMake(12.23, -0.73), controlPoint2: CGPointMake(10.13, -0.97))
        rectangle27Path.addCurveToPoint(CGPointMake(6.86, -0.73), controlPoint1: CGPointMake(8.89, -0.49), controlPoint2: CGPointMake(6.62, -1.09))
        rectangle27Path.addCurveToPoint(CGPointMake(6.86, 1.62), controlPoint1: CGPointMake(7.11, -0.37), controlPoint2: CGPointMake(6.86, 1.62))
        rectangle27Path.closePath()
        CGContextSaveGState(context)
        rectangle27Path.addClip()
        CGContextDrawLinearGradient(context, gradient3, CGPointMake(18.2, -1.44), CGPointMake(18.2, 3.56), 0)
        CGContextRestoreGState(context)


        //// Rectangle 28 Drawing
        var rectangle28Path = UIBezierPath()
        rectangle28Path.moveToPoint(CGPointMake(-1.74, -4.06))
        rectangle28Path.addCurveToPoint(CGPointMake(-4.37, -4.02), controlPoint1: CGPointMake(-1.74, -4.06), controlPoint2: CGPointMake(-2.92, -4.03))
        rectangle28Path.addCurveToPoint(CGPointMake(-8.63, -4.02), controlPoint1: CGPointMake(-5.59, -4.02), controlPoint2: CGPointMake(-7.24, -4.13))
        rectangle28Path.addCurveToPoint(CGPointMake(-14.83, -4.03), controlPoint1: CGPointMake(-10.02, -3.91), controlPoint2: CGPointMake(-14.34, -4.15))
        rectangle28Path.addCurveToPoint(CGPointMake(-19.32, -4.06), controlPoint1: CGPointMake(-15.45, -3.88), controlPoint2: CGPointMake(-19.08, -4.04))
        rectangle28Path.addCurveToPoint(CGPointMake(-19.32, -2.64), controlPoint1: CGPointMake(-20.1, -4.13), controlPoint2: CGPointMake(-19.32, -2.64))
        rectangle28Path.addCurveToPoint(CGPointMake(-17.38, -2.64), controlPoint1: CGPointMake(-19.32, -2.64), controlPoint2: CGPointMake(-18.16, -2.75))
        rectangle28Path.addCurveToPoint(CGPointMake(-14.44, -2.64), controlPoint1: CGPointMake(-16.61, -2.53), controlPoint2: CGPointMake(-13.98, -2.5))
        rectangle28Path.addCurveToPoint(CGPointMake(-10.02, -2.83), controlPoint1: CGPointMake(-14.91, -2.79), controlPoint2: CGPointMake(-11.81, -2.72))
        rectangle28Path.addCurveToPoint(CGPointMake(-7.08, -2.64), controlPoint1: CGPointMake(-8.24, -2.93), controlPoint2: CGPointMake(-7.08, -2.64))
        rectangle28Path.addCurveToPoint(CGPointMake(-4.37, -2.64), controlPoint1: CGPointMake(-7.08, -2.64), controlPoint2: CGPointMake(-4.99, -2.5))
        rectangle28Path.addCurveToPoint(CGPointMake(-1.74, -2.64), controlPoint1: CGPointMake(-3.75, -2.79), controlPoint2: CGPointMake(-1.49, -2.43))
        rectangle28Path.addCurveToPoint(CGPointMake(-1.74, -4.06), controlPoint1: CGPointMake(-1.98, -2.86), controlPoint2: CGPointMake(-1.74, -4.06))
        ...
        rectangle29Path.moveToPoint(CGPointMake(-14.05, 6.58))
        rectangle29Path.addCurveToPoint(CGPointMake(-17.67, 6.52), controlPoint1: CGPointMake(-14.05, 6.58), controlPoint2: CGPointMake(-15.68, 6.53))
        rectangle29Path.addCurveToPoint(CGPointMake(-23.54, 6.52), controlPoint1: CGPointMake(-19.36, 6.51), controlPoint2: CGPointMake(-21.62, 6.7))
        rectangle29Path.addCurveToPoint(CGPointMake(-32.07, 6.52), controlPoint1: CGPointMake(-25.45, 6.34), controlPoint2: CGPointMake(-31.4, 6.72))
        rectangle29Path.addCurveToPoint(CGPointMake(-38.24, 6.58), controlPoint1: CGPointMake(-32.92, 6.28), controlPoint2: CGPointMake(-37.91, 6.54))
        rectangle29Path.addCurveToPoint(CGPointMake(-38.24, 4.23), controlPoint1: CGPointMake(-39.31, 6.7), controlPoint2: CGPointMake(-38.24, 4.23))
        rectangle29Path.addCurveToPoint(CGPointMake(-35.58, 4.23), controlPoint1: CGPointMake(-38.24, 4.23), controlPoint2: CGPointMake(-36.65, 4.41))
        rectangle29Path.addCurveToPoint(CGPointMake(-31.53, 4.23), controlPoint1: CGPointMake(-34.51, 4.04), controlPoint2: CGPointMake(-30.89, 3.98))
        rectangle29Path.addCurveToPoint(CGPointMake(-25.45, 4.53), controlPoint1: CGPointMake(-32.17, 4.47), controlPoint2: CGPointMake(-27.91, 4.35))
        rectangle29Path.addCurveToPoint(CGPointMake(-21.4, 4.23), controlPoint1: CGPointMake(-23, 4.71), controlPoint2: CGPointMake(-21.4, 4.23))
        rectangle29Path.addCurveToPoint(CGPointMake(-17.67, 4.23), controlPoint1: CGPointMake(-21.4, 4.23), controlPoint2: CGPointMake(-18.53, 3.98))
        rectangle29Path.addCurveToPoint(CGPointMake(-14.05, 4.23), controlPoint1: CGPointMake(-16.82, 4.47), controlPoint2: CGPointMake(-13.71, 3.86))
        rectangle29Path.addCurveToPoint(CGPointMake(-14.05, 6.58), controlPoint1: CGPointMake(-14.39, 4.59), controlPoint2: CGPointMake(-14.05, 6.58))
        ...
        rectangle30Path.moveToPoint(CGPointMake(36.74, 5.82))
        rectangle30Path.addCurveToPoint(CGPointMake(35.82, 5.77), controlPoint1: CGPointMake(36.74, 5.82), controlPoint2: CGPointMake(36.33, 5.78))
        rectangle30Path.addCurveToPoint(CGPointMake(34.34, 5.77), controlPoint1: CGPointMake(35.4, 5.77), controlPoint2: CGPointMake(34.83, 5.91))
        rectangle30Path.addCurveToPoint(CGPointMake(32.19, 5.78), controlPoint1: CGPointMake(33.86, 5.64), controlPoint2: CGPointMake(32.36, 5.93))
        rectangle30Path.addCurveToPoint(CGPointMake(30.63, 5.82), controlPoint1: CGPointMake(31.98, 5.59), controlPoint2: CGPointMake(30.72, 5.79))
        rectangle30Path.addCurveToPoint(CGPointMake(30.63, 4.05), controlPoint1: CGPointMake(30.36, 5.91), controlPoint2: CGPointMake(30.63, 4.05))
        rectangle30Path.addCurveToPoint(CGPointMake(31.3, 4.05), controlPoint1: CGPointMake(30.63, 4.05), controlPoint2: CGPointMake(31.04, 4.18))
        rectangle30Path.addCurveToPoint(CGPointMake(32.33, 4.05), controlPoint1: CGPointMake(31.57, 3.91), controlPoint2: CGPointMake(32.49, 3.87))
        rectangle30Path.addCurveToPoint(CGPointMake(33.86, 4.28), controlPoint1: CGPointMake(32.17, 4.23), controlPoint2: CGPointMake(33.24, 4.14))
        rectangle30Path.addCurveToPoint(CGPointMake(34.88, 4.05), controlPoint1: CGPointMake(34.48, 4.41), controlPoint2: CGPointMake(34.88, 4.05))
        rectangle30Path.addCurveToPoint(CGPointMake(35.82, 4.05), controlPoint1: CGPointMake(34.88, 4.05), controlPoint2: CGPointMake(35.61, 3.87))
        rectangle30Path.addCurveToPoint(CGPointMake(36.74, 4.05), controlPoint1: CGPointMake(36.04, 4.23), controlPoint2: CGPointMake(36.82, 3.78))
        rectangle30Path.addCurveToPoint(CGPointMake(36.74, 5.82), controlPoint1: CGPointMake(36.65, 4.32), controlPoint2: CGPointMake(36.74, 5.82))
        ...
        rectangle31Path.moveToPoint(CGPointMake(13.31, 5.08))
        rectangle31Path.addCurveToPoint(CGPointMake(10.68, 5.12), controlPoint1: CGPointMake(13.31, 5.08), controlPoint2: CGPointMake(12.13, 5.11))
        rectangle31Path.addCurveToPoint(CGPointMake(6.42, 5.12), controlPoint1: CGPointMake(9.46, 5.12), controlPoint2: CGPointMake(7.81, 5.01))
        rectangle31Path.addCurveToPoint(CGPointMake(0.22, 5.11), controlPoint1: CGPointMake(5.03, 5.23), controlPoint2: CGPointMake(0.71, 5))
        rectangle31Path.addCurveToPoint(CGPointMake(-4.27, 5.08), controlPoint1: CGPointMake(-0.4, 5.26), controlPoint2: CGPointMake(-4.03, 5.11))
        rectangle31Path.addCurveToPoint(CGPointMake(-4.27, 6.5), controlPoint1: CGPointMake(-5.05, 5.01), controlPoint2: CGPointMake(-4.27, 6.5))
        rectangle31Path.addCurveToPoint(CGPointMake(-2.33, 6.5), controlPoint1: CGPointMake(-4.27, 6.5), controlPoint2: CGPointMake(-3.11, 6.39))
        rectangle31Path.addCurveToPoint(CGPointMake(0.61, 6.5), controlPoint1: CGPointMake(-1.56, 6.61), controlPoint2: CGPointMake(1.07, 6.64))
        rectangle31Path.addCurveToPoint(CGPointMake(5.03, 6.32), controlPoint1: CGPointMake(0.14, 6.35), controlPoint2: CGPointMake(3.24, 6.43))
        rectangle31Path.addCurveToPoint(CGPointMake(7.97, 6.5), controlPoint1: CGPointMake(6.81, 6.21), controlPoint2: CGPointMake(7.97, 6.5))
        rectangle31Path.addCurveToPoint(CGPointMake(10.68, 6.5), controlPoint1: CGPointMake(7.97, 6.5), controlPoint2: CGPointMake(10.06, 6.64))
        rectangle31Path.addCurveToPoint(CGPointMake(13.31, 6.5), controlPoint1: CGPointMake(11.3, 6.35), controlPoint2: CGPointMake(13.56, 6.72))
        rectangle31Path.addCurveToPoint(CGPointMake(13.31, 5.08), controlPoint1: CGPointMake(13.07, 6.28), controlPoint2: CGPointMake(13.31, 5.08))
        ...
        rectangle32Path.moveToPoint(CGPointMake(21.01, -4.06))
        rectangle32Path.addCurveToPoint(CGPointMake(19.4, -4.02), controlPoint1: CGPointMake(21.01, -4.06), controlPoint2: CGPointMake(20.29, -4.03))
        rectangle32Path.addCurveToPoint(CGPointMake(16.78, -4.02), controlPoint1: CGPointMake(18.65, -4.02), controlPoint2: CGPointMake(17.64, -4.13))
        rectangle32Path.addCurveToPoint(CGPointMake(12.97, -4.03), controlPoint1: CGPointMake(15.92, -3.91), controlPoint2: CGPointMake(13.27, -4.15))
        rectangle32Path.addCurveToPoint(CGPointMake(10.21, -4.06), controlPoint1: CGPointMake(12.59, -3.88), controlPoint2: CGPointMake(10.36, -4.04))
        rectangle32Path.addCurveToPoint(CGPointMake(10.21, -2.64), controlPoint1: CGPointMake(9.74, -4.13), controlPoint2: CGPointMake(10.21, -2.64))
        rectangle32Path.addCurveToPoint(CGPointMake(11.4, -2.64), controlPoint1: CGPointMake(10.21, -2.64), controlPoint2: CGPointMake(10.93, -2.75))
        rectangle32Path.addCurveToPoint(CGPointMake(13.21, -2.64), controlPoint1: CGPointMake(11.88, -2.53), controlPoint2: CGPointMake(13.5, -2.5))
        rectangle32Path.addCurveToPoint(CGPointMake(15.92, -2.83), controlPoint1: CGPointMake(12.92, -2.79), controlPoint2: CGPointMake(14.83, -2.72))
        rectangle32Path.addCurveToPoint(CGPointMake(17.73, -2.64), controlPoint1: CGPointMake(17.02, -2.93), controlPoint2: CGPointMake(17.73, -2.64))
        rectangle32Path.addCurveToPoint(CGPointMake(19.4, -2.64), controlPoint1: CGPointMake(17.73, -2.64), controlPoint2: CGPointMake(19.02, -2.5))
        rectangle32Path.addCurveToPoint(CGPointMake(21.01, -2.64), controlPoint1: CGPointMake(19.78, -2.79), controlPoint2: CGPointMake(21.17, -2.43))
        rectangle32Path.addCurveToPoint(CGPointMake(21.01, -4.06), controlPoint1: CGPointMake(20.86, -2.86), controlPoint2: CGPointMake(21.01, -4.06))
        ...
        rectangle33Path.moveToPoint(CGPointMake(1.1, -0.25))
        rectangle33Path.addCurveToPoint(CGPointMake(0.26, -0.2), controlPoint1: CGPointMake(1.1, -0.25), controlPoint2: CGPointMake(0.72, -0.21))
        rectangle33Path.addCurveToPoint(CGPointMake(-1.1, -0.2), controlPoint1: CGPointMake(-0.13, -0.2), controlPoint2: CGPointMake(-0.65, -0.34))
        rectangle33Path.addCurveToPoint(CGPointMake(-3.07, -0.21), controlPoint1: CGPointMake(-1.54, -0.07), controlPoint2: CGPointMake(-2.92, -0.35))
        rectangle33Path.addCurveToPoint(CGPointMake(-4.51, -0.25), controlPoint1: CGPointMake(-3.27, -0.02), controlPoint2: CGPointMake(-4.43, -0.22))
        rectangle33Path.addCurveToPoint(CGPointMake(-4.51, 1.52), controlPoint1: CGPointMake(-4.75, -0.34), controlPoint2: CGPointMake(-4.51, 1.52))
        rectangle33Path.addCurveToPoint(CGPointMake(-3.89, 1.52), controlPoint1: CGPointMake(-4.51, 1.52), controlPoint2: CGPointMake(-4.14, 1.39))
        rectangle33Path.addCurveToPoint(CGPointMake(-2.95, 1.52), controlPoint1: CGPointMake(-3.64, 1.66), controlPoint2: CGPointMake(-2.8, 1.7))
        rectangle33Path.addCurveToPoint(CGPointMake(-1.54, 1.3), controlPoint1: CGPointMake(-3.1, 1.34), controlPoint2: CGPointMake(-2.11, 1.43))
        rectangle33Path.addCurveToPoint(CGPointMake(-0.61, 1.52), controlPoint1: CGPointMake(-0.98, 1.16), controlPoint2: CGPointMake(-0.61, 1.52))
        rectangle33Path.addCurveToPoint(CGPointMake(0.26, 1.52), controlPoint1: CGPointMake(-0.61, 1.52), controlPoint2: CGPointMake(0.06, 1.7))
        rectangle33Path.addCurveToPoint(CGPointMake(4.36, 1.26), controlPoint1: CGPointMake(0.46, 1.34), controlPoint2: CGPointMake(5.13, 2.4))
        rectangle33Path.addCurveToPoint(CGPointMake(1.1, -0.25), controlPoint1: CGPointMake(3.59, 0.12), controlPoint2: CGPointMake(1.1, -0.25))
        ...
        rectangle34Path.moveToPoint(CGPointMake(-7.46, 3.56))
        rectangle34Path.addCurveToPoint(CGPointMake(-11.15, 3.6), controlPoint1: CGPointMake(-7.46, 3.56), controlPoint2: CGPointMake(-9.12, 3.59))
        rectangle34Path.addCurveToPoint(CGPointMake(-17.12, 3.6), controlPoint1: CGPointMake(-12.86, 3.6), controlPoint2: CGPointMake(-15.16, 3.49))
        rectangle34Path.addCurveToPoint(CGPointMake(-25.79, 3.59), controlPoint1: CGPointMake(-19.07, 3.7), controlPoint2: CGPointMake(-25.11, 3.47))
        rectangle34Path.addCurveToPoint(CGPointMake(-32.08, 3.56), controlPoint1: CGPointMake(-26.66, 3.74), controlPoint2: CGPointMake(-31.74, 3.58))
        rectangle34Path.addCurveToPoint(CGPointMake(-32.08, 4.98), controlPoint1: CGPointMake(-33.17, 3.49), controlPoint2: CGPointMake(-32.08, 4.98))
        rectangle34Path.addCurveToPoint(CGPointMake(-29.37, 4.98), controlPoint1: CGPointMake(-32.08, 4.98), controlPoint2: CGPointMake(-30.46, 4.87))
        rectangle34Path.addCurveToPoint(CGPointMake(-25.25, 4.98), controlPoint1: CGPointMake(-28.29, 5.08), controlPoint2: CGPointMake(-24.6, 5.12))
        rectangle34Path.addCurveToPoint(CGPointMake(-19.07, 4.79), controlPoint1: CGPointMake(-25.9, 4.83), controlPoint2: CGPointMake(-21.56, 4.9))
        rectangle34Path.addCurveToPoint(CGPointMake(-14.95, 4.98), controlPoint1: CGPointMake(-16.57, 4.68), controlPoint2: CGPointMake(-14.95, 4.98))
        rectangle34Path.addCurveToPoint(CGPointMake(-11.15, 4.98), controlPoint1: CGPointMake(-14.95, 4.98), controlPoint2: CGPointMake(-12.02, 5.12))
        rectangle34Path.addCurveToPoint(CGPointMake(-3.08, 5.07), controlPoint1: CGPointMake(-10.28, 4.83), controlPoint2: CGPointMake(-2.73, 5.29))
        rectangle34Path.addCurveToPoint(CGPointMake(-7.46, 3.56), controlPoint1: CGPointMake(-3.42, 4.85), controlPoint2: CGPointMake(-7.46, 3.56))
        ...
        rectangle35Path.moveToPoint(CGPointMake(29.74, 7.36))
        rectangle35Path.addCurveToPoint(CGPointMake(23.47, 5.89), controlPoint1: CGPointMake(29.74, 7.36), controlPoint2: CGPointMake(24.23, 5.89))
        rectangle35Path.addCurveToPoint(CGPointMake(21.22, 5.89), controlPoint1: CGPointMake(22.82, 5.9), controlPoint2: CGPointMake(21.95, 5.76))
        rectangle35Path.addCurveToPoint(CGPointMake(17.94, 5.89), controlPoint1: CGPointMake(20.48, 6.03), controlPoint2: CGPointMake(18.2, 5.74))
        rectangle35Path.addCurveToPoint(CGPointMake(15.57, 5.85), controlPoint1: CGPointMake(17.61, 6.07), controlPoint2: CGPointMake(15.7, 5.88))
        rectangle35Path.addCurveToPoint(CGPointMake(15.57, 7.62), controlPoint1: CGPointMake(15.16, 5.76), controlPoint2: CGPointMake(15.57, 7.62))
        rectangle35Path.addCurveToPoint(CGPointMake(16.59, 7.62), controlPoint1: CGPointMake(15.57, 7.62), controlPoint2: CGPointMake(16.18, 7.48))
        rectangle35Path.addCurveToPoint(CGPointMake(18.15, 7.62), controlPoint1: CGPointMake(17, 7.75), controlPoint2: CGPointMake(18.39, 7.8))
        rectangle35Path.addCurveToPoint(CGPointMake(20.48, 7.39), controlPoint1: CGPointMake(17.9, 7.44), controlPoint2: CGPointMake(19.54, 7.53))
        rectangle35Path.addCurveToPoint(CGPointMake(22.04, 7.62), controlPoint1: CGPointMake(21.42, 7.26), controlPoint2: CGPointMake(22.04, 7.62))
        rectangle35Path.addCurveToPoint(CGPointMake(23.47, 7.62), controlPoint1: CGPointMake(22.04, 7.62), controlPoint2: CGPointMake(23.14, 7.8))
        rectangle35Path.addCurveToPoint(CGPointMake(24.86, 7.62), controlPoint1: CGPointMake(23.8, 7.44), controlPoint2: CGPointMake(24.99, 7.89))
        rectangle35Path.addCurveToPoint(CGPointMake(29.74, 7.36), controlPoint1: CGPointMake(24.73, 7.35), controlPoint2: CGPointMake(29.74, 7.36))
        rectangle35Path.closePath()
        CGContextSaveGState(context)
        rectangle35Path.addClip()
        CGContextDrawLinearGradient(context, gradient4, CGPointMake(22.56, 7.74), CGPointMake(22.56, 5.83), 0)
        CGContextRestoreGState(context)


        //// Rectangle 36 Drawing
        var rectangle36Path = UIBezierPath()
        rectangle36Path.moveToPoint(CGPointMake(32.12, -2.91))
        rectangle36Path.addCurveToPoint(CGPointMake(31.28, -2.87), controlPoint1: CGPointMake(32.12, -2.91), controlPoint2: CGPointMake(31.75, -2.88))
        rectangle36Path.addCurveToPoint(CGPointMake(27.95, -5.21), controlPoint1: CGPointMake(30.89, -2.86), controlPoint2: CGPointMake(28.39, -5.35))
        rectangle36Path.addCurveToPoint(CGPointMake(27.95, -2.87), controlPoint1: CGPointMake(27.5, -5.08), controlPoint2: CGPointMake(28.11, -3.02))
        rectangle36Path.addCurveToPoint(CGPointMake(26.52, -2.91), controlPoint1: CGPointMake(27.75, -2.69), controlPoint2: CGPointMake(26.6, -2.89))
        rectangle36Path.addCurveToPoint(CGPointMake(26.52, -1.14), controlPoint1: CGPointMake(26.27, -3.01), controlPoint2: CGPointMake(26.52, -1.14))
        rectangle36Path.addCurveToPoint(CGPointMake(27.14, -1.14), controlPoint1: CGPointMake(26.52, -1.14), controlPoint2: CGPointMake(26.89, -1.28))
        rectangle36Path.addCurveToPoint(CGPointMake(28.08, -1.14), controlPoint1: CGPointMake(27.38, -1.01), controlPoint2: CGPointMake(28.22, -0.96))
        rectangle36Path.addCurveToPoint(CGPointMake(29.48, -1.37), controlPoint1: CGPointMake(27.93, -1.33), controlPoint2: CGPointMake(28.91, -1.23))
        rectangle36Path.addCurveToPoint(CGPointMake(30.42, -1.14), controlPoint1: CGPointMake(30.05, -1.51), controlPoint2: CGPointMake(30.42, -1.14))
        rectangle36Path.addCurveToPoint(CGPointMake(31.28, -1.14), controlPoint1: CGPointMake(30.42, -1.14), controlPoint2: CGPointMake(31.09, -0.96))
        rectangle36Path.addCurveToPoint(CGPointMake(32.12, -1.14), controlPoint1: CGPointMake(31.48, -1.33), controlPoint2: CGPointMake(32.2, -0.87))
        rectangle36Path.addCurveToPoint(CGPointMake(32.12, -2.91), controlPoint1: CGPointMake(32.04, -1.42), controlPoint2: CGPointMake(32.12, -2.91))
        ...
        rectangle37Path.moveToPoint(CGPointMake(15.44, -0.66))
        rectangle37Path.addCurveToPoint(CGPointMake(11.81, -0.72), controlPoint1: CGPointMake(15.44, -0.66), controlPoint2: CGPointMake(13.8, -0.71))
        rectangle37Path.addCurveToPoint(CGPointMake(5.95, -0.72), controlPoint1: CGPointMake(10.13, -0.73), controlPoint2: CGPointMake(7.87, -0.54))
        rectangle37Path.addCurveToPoint(CGPointMake(-2.58, -0.71), controlPoint1: CGPointMake(4.03, -0.9), controlPoint2: CGPointMake(-1.91, -0.52))
        rectangle37Path.addCurveToPoint(CGPointMake(-8.76, -0.66), controlPoint1: CGPointMake(-3.43, -0.96), controlPoint2: CGPointMake(-8.42, -0.7))
        rectangle37Path.addCurveToPoint(CGPointMake(-8.76, -3.01), controlPoint1: CGPointMake(-9.82, -0.54), controlPoint2: CGPointMake(-8.76, -3.01))
        rectangle37Path.addCurveToPoint(CGPointMake(-6.09, -3.01), controlPoint1: CGPointMake(-8.76, -3.01), controlPoint2: CGPointMake(-7.16, -2.83))
        rectangle37Path.addCurveToPoint(CGPointMake(-2.04, -3.01), controlPoint1: CGPointMake(-5.03, -3.19), controlPoint2: CGPointMake(-1.4, -3.25))
        rectangle37Path.addCurveToPoint(CGPointMake(4.03, -2.71), controlPoint1: CGPointMake(-2.68, -2.77), controlPoint2: CGPointMake(1.58, -2.89))
        rectangle37Path.addCurveToPoint(CGPointMake(8.08, -3.01), controlPoint1: CGPointMake(6.48, -2.53), controlPoint2: CGPointMake(8.08, -3.01))
        rectangle37Path.addCurveToPoint(CGPointMake(11.81, -3.01), controlPoint1: CGPointMake(8.08, -3.01), controlPoint2: CGPointMake(10.96, -3.25))
        rectangle37Path.addCurveToPoint(CGPointMake(15.44, -3.01), controlPoint1: CGPointMake(12.67, -2.77), controlPoint2: CGPointMake(15.78, -3.37))
        rectangle37Path.addCurveToPoint(CGPointMake(15.44, -0.66), controlPoint1: CGPointMake(15.1, -2.65), controlPoint2: CGPointMake(15.44, -0.66))
        ...
        rectangle38Path.addCurveToPoint(CGPointMake(-31.92, -7.46), controlPoint1: CGPointMake(-30.52, -7.49), controlPoint2: CGPointMake(-31.15, -7.47))
        rectangle38Path.addCurveToPoint(CGPointMake(-34.17, -7.46), controlPoint1: CGPointMake(-32.56, -7.46), controlPoint2: CGPointMake(-33.43, -7.55))
        rectangle38Path.addCurveToPoint(CGPointMake(-37.44, -7.47), controlPoint1: CGPointMake(-34.9, -7.38), controlPoint2: CGPointMake(-37.19, -7.56))
        rectangle38Path.addCurveToPoint(CGPointMake(-39.82, -7.49), controlPoint1: CGPointMake(-37.77, -7.36), controlPoint2: CGPointMake(-39.69, -7.47))
        rectangle38Path.addCurveToPoint(CGPointMake(-39.82, -6.43), controlPoint1: CGPointMake(-40.23, -7.55), controlPoint2: CGPointMake(-39.82, -6.43))
        rectangle38Path.addCurveToPoint(CGPointMake(-38.79, -6.43), controlPoint1: CGPointMake(-39.82, -6.43), controlPoint2: CGPointMake(-39.2, -6.51))
        rectangle38Path.addCurveToPoint(CGPointMake(-37.24, -6.43), controlPoint1: CGPointMake(-38.38, -6.35), controlPoint2: CGPointMake(-36.99, -6.32))
        rectangle38Path.addCurveToPoint(CGPointMake(-34.9, -6.57), controlPoint1: CGPointMake(-37.48, -6.54), controlPoint2: CGPointMake(-35.85, -6.48))
        rectangle38Path.addCurveToPoint(CGPointMake(-33.35, -6.43), controlPoint1: CGPointMake(-33.96, -6.65), controlPoint2: CGPointMake(-33.35, -6.43))
        rectangle38Path.addCurveToPoint(CGPointMake(-31.92, -6.43), controlPoint1: CGPointMake(-33.35, -6.43), controlPoint2: CGPointMake(-32.24, -6.32))
        rectangle38Path.addCurveToPoint(CGPointMake(-30.52, -6.43), controlPoint1: CGPointMake(-31.59, -6.54), controlPoint2: CGPointMake(-30.39, -6.27))
        rectangle38Path.addCurveToPoint(CGPointMake(-30.52, -7.49), controlPoint1: CGPointMake(-30.65, -6.59), controlPoint2: CGPointMake(-30.52, -7.49))
        rectangle38Path.closePath()
        CGContextSaveGState(context)
        rectangle38Path.addClip()
        CGContextDrawLinearGradient(context, gradient4, CGPointMake(-35.26, -6.36), CGPointMake(-35.26, -7.5), 0)
        CGContextRestoreGState(context)


        //// Rectangle 39 Drawing
        var rectangle39Path = UIBezierPath()
        rectangle39Path.moveToPoint(CGPointMake(-15.4, -3.3))
        rectangle39Path.addCurveToPoint(CGPointMake(-17.28, -3.29), controlPoint1: CGPointMake(-15.4, -3.3), controlPoint2: CGPointMake(-16.25, -3.29))
        rectangle39Path.addCurveToPoint(CGPointMake(-20.32, -3.29), controlPoint1: CGPointMake(-18.15, -3.28), controlPoint2: CGPointMake(-19.33, -3.34))
        rectangle39Path.addCurveToPoint(CGPointMake(-24.75, -3.29), controlPoint1: CGPointMake(-21.32, -3.23), controlPoint2: CGPointMake(-24.4, -3.35))
        rectangle39Path.addCurveToPoint(CGPointMake(-27.96, -3.3), controlPoint1: CGPointMake(-25.19, -3.21), controlPoint2: CGPointMake(-27.78, -3.29))
        rectangle39Path.addCurveToPoint(CGPointMake(-27.96, -2.6), controlPoint1: CGPointMake(-28.51, -3.34), controlPoint2: CGPointMake(-27.96, -2.6))
        rectangle39Path.addCurveToPoint(CGPointMake(-26.58, -2.6), controlPoint1: CGPointMake(-27.96, -2.6), controlPoint2: CGPointMake(-27.13, -2.65))
        rectangle39Path.addCurveToPoint(CGPointMake(-24.47, -2.6), controlPoint1: CGPointMake(-26.02, -2.54), controlPoint2: CGPointMake(-24.14, -2.52))
        rectangle39Path.addCurveToPoint(CGPointMake(-21.32, -2.69), controlPoint1: CGPointMake(-24.81, -2.67), controlPoint2: CGPointMake(-22.59, -2.63))
        rectangle39Path.addCurveToPoint(CGPointMake(-19.22, -2.6), controlPoint1: CGPointMake(-20.05, -2.74), controlPoint2: CGPointMake(-19.22, -2.6))
        rectangle39Path.addCurveToPoint(CGPointMake(-17.28, -2.6), controlPoint1: CGPointMake(-19.22, -2.6), controlPoint2: CGPointMake(-17.72, -2.52))
        rectangle39Path.addCurveToPoint(CGPointMake(-15.4, -2.6), controlPoint1: CGPointMake(-16.84, -2.67), controlPoint2: CGPointMake(-15.22, -2.49))
        rectangle39Path.addCurveToPoint(CGPointMake(-15.4, -3.3), controlPoint1: CGPointMake(-15.58, -2.7), controlPoint2: CGPointMake(-15.4, -3.3))
        rectangle39Path.closePath()
        CGContextSaveGState(context)
        rectangle39Path.addClip()
        CGContextDrawLinearGradient(context, gradient4, CGPointMake(-21.79, -2.55), CGPointMake(-21.79, -3.31), 0)
        CGContextRestoreGState(context)


        //// Rectangle 40 Drawing
        var rectangle40Path = UIBezierPath()
        rectangle40Path.moveToPoint(CGPointMake(39.8, 1.78))
        rectangle40Path.addCurveToPoint(CGPointMake(36.17, 1.76), controlPoint1: CGPointMake(39.8, 1.78), controlPoint2: CGPointMake(38.16, 1.76))
        rectangle40Path.addCurveToPoint(CGPointMake(30.31, 1.76), controlPoint1: CGPointMake(34.49, 1.75), controlPoint2: CGPointMake(32.23, 1.81))
        rectangle40Path.addCurveToPoint(CGPointMake(21.78, 1.76), controlPoint1: CGPointMake(28.39, 1.7), controlPoint2: CGPointMake(22.45, 1.82))
        rectangle40Path.addCurveToPoint(CGPointMake(15.6, 1.78), controlPoint1: CGPointMake(20.93, 1.68), controlPoint2: CGPointMake(15.94, 1.76))
        rectangle40Path.addCurveToPoint(CGPointMake(15.6, 1.07), controlPoint1: CGPointMake(14.54, 1.81), controlPoint2: CGPointMake(15.6, 1.07))
        rectangle40Path.addCurveToPoint(CGPointMake(18.27, 1.07), controlPoint1: CGPointMake(15.6, 1.07), controlPoint2: CGPointMake(17.2, 1.12))
        rectangle40Path.addCurveToPoint(CGPointMake(22.32, 1.07), controlPoint1: CGPointMake(19.33, 1.01), controlPoint2: CGPointMake(22.96, 0.99))
        rectangle40Path.addCurveToPoint(CGPointMake(28.39, 1.16), controlPoint1: CGPointMake(21.68, 1.14), controlPoint2: CGPointMake(25.94, 1.1))
        rectangle40Path.addCurveToPoint(CGPointMake(32.44, 1.07), controlPoint1: CGPointMake(30.84, 1.21), controlPoint2: CGPointMake(32.44, 1.07))
        rectangle40Path.addCurveToPoint(CGPointMake(36.17, 1.07), controlPoint1: CGPointMake(32.44, 1.07), controlPoint2: CGPointMake(35.32, 0.99))
        rectangle40Path.addCurveToPoint(CGPointMake(39.8, 1.07), controlPoint1: CGPointMake(37.02, 1.14), controlPoint2: CGPointMake(40.14, 0.96))
        rectangle40Path.addCurveToPoint(CGPointMake(39.8, 1.78), controlPoint1: CGPointMake(39.45, 1.18), controlPoint2: CGPointMake(39.8, 1.78))
        ...
        rectangle41Path.moveToPoint(CGPointMake(27.67, -0.25))
        rectangle41Path.addCurveToPoint(CGPointMake(25.23, -0.2), controlPoint1: CGPointMake(27.67, -0.25), controlPoint2: CGPointMake(26.57, -0.21))
        rectangle41Path.addCurveToPoint(CGPointMake(21.27, -0.2), controlPoint1: CGPointMake(24.09, -0.2), controlPoint2: CGPointMake(22.57, -0.34))
        rectangle41Path.addCurveToPoint(CGPointMake(15.52, -0.21), controlPoint1: CGPointMake(19.98, -0.07), controlPoint2: CGPointMake(15.97, -0.35))
        rectangle41Path.addCurveToPoint(CGPointMake(11.35, -0.25), controlPoint1: CGPointMake(14.94, -0.02), controlPoint2: CGPointMake(11.57, -0.22))
        rectangle41Path.addCurveToPoint(CGPointMake(11.35, 1.52), controlPoint1: CGPointMake(10.63, -0.34), controlPoint2: CGPointMake(11.35, 1.52))
        rectangle41Path.addCurveToPoint(CGPointMake(13.14, 1.52), controlPoint1: CGPointMake(11.35, 1.52), controlPoint2: CGPointMake(12.42, 1.39))
        rectangle41Path.addCurveToPoint(CGPointMake(15.88, 1.52), controlPoint1: CGPointMake(13.86, 1.66), controlPoint2: CGPointMake(16.31, 1.7))
        rectangle41Path.addCurveToPoint(CGPointMake(19.98, 1.3), controlPoint1: CGPointMake(15.45, 1.34), controlPoint2: CGPointMake(18.32, 1.43))
        rectangle41Path.addCurveToPoint(CGPointMake(22.71, 1.52), controlPoint1: CGPointMake(21.63, 1.16), controlPoint2: CGPointMake(22.71, 1.52))
        rectangle41Path.addCurveToPoint(CGPointMake(25.23, 1.52), controlPoint1: CGPointMake(22.71, 1.52), controlPoint2: CGPointMake(24.65, 1.7))
        rectangle41Path.addCurveToPoint(CGPointMake(30, 1.64), controlPoint1: CGPointMake(25.8, 1.34), controlPoint2: CGPointMake(27.18, 2.02))
        rectangle41Path.addCurveToPoint(CGPointMake(27.67, -0.25), controlPoint1: CGPointMake(32.82, 1.26), controlPoint2: CGPointMake(27.67, -0.25))
        rectangle41Path.closePath()
        CGContextSaveGState(context)
        rectangle41Path.addClip()
        CGContextDrawLinearGradient(context, gradient4, CGPointMake(20.94, 1.76), CGPointMake(20.94, -0.26), 0)
        CGContextRestoreGState(context)


        //// Rectangle 42 Drawing
        var rectangle42Path = UIBezierPath()
        rectangle42Path.moveToPoint(CGPointMake(-15.33, 0.1))
        rectangle42Path.addCurveToPoint(CGPointMake(-20.51, 1.26), controlPoint1: CGPointMake(-15.33, 0.1), controlPoint2: CGPointMake(-18.72, 0.12))
        rectangle42Path.addCurveToPoint(CGPointMake(-24.82, 0.04), controlPoint1: CGPointMake(-22.03, 2.23), controlPoint2: CGPointMake(-22.9, 0.22))
        rectangle42Path.addCurveToPoint(CGPointMake(-33.35, 0.05), controlPoint1: CGPointMake(-26.74, -0.14), controlPoint2: CGPointMake(-32.68, 0.24))
        rectangle42Path.addCurveToPoint(CGPointMake(-39.53, 0.1), controlPoint1: CGPointMake(-34.2, -0.2), controlPoint2: CGPointMake(-39.19, 0.06))
        rectangle42Path.addCurveToPoint(CGPointMake(-39.53, -2.25), controlPoint1: CGPointMake(-40.59, 0.22), controlPoint2: CGPointMake(-39.53, -2.25))
        rectangle42Path.addCurveToPoint(CGPointMake(-36.86, -2.25), controlPoint1: CGPointMake(-39.53, -2.25), controlPoint2: CGPointMake(-37.93, -2.07))
        rectangle42Path.addCurveToPoint(CGPointMake(-32.81, -2.25), controlPoint1: CGPointMake(-35.8, -2.43), controlPoint2: CGPointMake(-32.17, -2.49))
        rectangle42Path.addCurveToPoint(CGPointMake(-26.74, -1.95), controlPoint1: CGPointMake(-33.45, -2.01), controlPoint2: CGPointMake(-29.19, -2.13))
        rectangle42Path.addCurveToPoint(CGPointMake(-22.69, -2.25), controlPoint1: CGPointMake(-24.29, -1.77), controlPoint2: CGPointMake(-22.69, -2.25))
        rectangle42Path.addCurveToPoint(CGPointMake(-18.96, -2.25), controlPoint1: CGPointMake(-22.69, -2.25), controlPoint2: CGPointMake(-19.81, -2.49))
        rectangle42Path.addCurveToPoint(CGPointMake(-15.33, -2.25), controlPoint1: CGPointMake(-18.1, -2.01), controlPoint2: CGPointMake(-14.99, -2.61))
        rectangle42Path.addCurveToPoint(CGPointMake(-15.33, 0.1), controlPoint1: CGPointMake(-15.67, -1.89), controlPoint2: CGPointMake(-15.33, 0.1))
        ...
        let rectangle44Path = UIBezierPath(rect: CGRectMake(-40, -6.5, 1, 15))
        CGContextSaveGState(context)
        rectangle44Path.addClip()
        CGContextDrawLinearGradient(context, gradient4, CGPointMake(-39, 1), CGPointMake(-40, 1), 0)
        CGContextRestoreGState(context)
